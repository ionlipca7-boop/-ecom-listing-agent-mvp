...
OUT = ROOT / "storage" / "memory" / "archive" / "live_listing_recovery_audit_v1.json"
TOKEN_CANDIDATES = [
...
def main():
    ...
    result = {}
    result["status"] = "OK"
    result["decision"] = "live_listing_recovery_audit_v1_completed"
    ...
    print("LIVE_LISTING_RECOVERY_AUDIT_V1")
