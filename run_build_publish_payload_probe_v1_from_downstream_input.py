...
def main():
    ...
    payload = {
        "status": "OK",
        "decision": "publish_payload_probe_v1_built_from_downstream_input",
    ...
    print("PUBLISH_PAYLOAD_PROBE_V1_AUDIT")
    print("status = OK")
    print("decision = publish_payload_probe_v1_built_from_downstream_input")
