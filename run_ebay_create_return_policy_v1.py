...
def main() -> None:
    ...
    try:
        ...
        (EXPORTS_DIR / "ebay_create_return_policy_audit_v1.json").write_text(json.dumps(audit, ensure_ascii=False, indent=2), encoding="utf-8")
    ...
    (EXPORTS_DIR / "ebay_create_return_policy_v1.json").write_text(json.dumps(data, ensure_ascii=False, indent=2), encoding="utf-8")
