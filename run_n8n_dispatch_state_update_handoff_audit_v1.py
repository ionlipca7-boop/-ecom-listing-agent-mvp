...
out = pathlib.Path(r"D:\ECOM_LISTING_AGENT_MVP\storage\audit\n8n_dispatch_state_update_handoff_v1_audit.txt")
lines = [
    "N8N_DISPATCH_STATE_UPDATE_HANDOFF_V1_AUDIT",
    "status = " + str(d.get("status")),
    "phase = " + str(d.get("phase")),
    "dispatcher_role = " + str(d.get("dispatcher_role")),
    "state_update_handoff_version = " + str(d.get("state_update_handoff_version")),
    ...
    "state_update_handoff_ready = " + str(d.get("state_update_handoff_ready")),
