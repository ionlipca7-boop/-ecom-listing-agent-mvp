...
PREV_FILE = EXPORTS_DIR / "publish_existing_offer_repair_v1.json"
OUT_FILE = EXPORTS_DIR / "publish_existing_offer_repair_v2.json"
...
def main():
    ...
    if inv_response.status_code not in (200, 201, 204):
        ...
        print("PUBLISH_EXISTING_REPAIR_V2_DONE")
