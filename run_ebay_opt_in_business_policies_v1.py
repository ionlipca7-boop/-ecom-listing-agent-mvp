...
def main() -> None:
    ...
    payload = json.dumps({"programTypes": ["SELLING_POLICY_MANAGEMENT"]}).encode("utf-8")
    ...
    try:
        ...
        (EXPORTS_DIR / "ebay_opt_in_business_policies_audit_v1.json").write_text(json.dumps(audit, ensure_ascii=False, indent=2), encoding="utf-8")
        print("OPT_IN_FAILED")
