...
OUTPUT_FILE = EXPORTS_DIR / "ebay_publish_offer_audit_v6.json"
...
def main():
    ...
    result = {"status": "OK" if response.status_code == 200 else "FAILED", "http_status": response.status_code, "offerId": OFFER_ID, "listingId": data.get("listingId") if isinstance(data, dict) else None, "response_json": data}
    OUTPUT_FILE.write_text(json.dumps(result, ensure_ascii=False, indent=2), encoding="utf-8")
    print("PUBLISH_OFFER_V6_DONE")
